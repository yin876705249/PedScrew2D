...
CONFIG_PREFIX="configs/spine_2d_keypoint/topdown_heatmap/spine/td-hm_ViTPose-small_8xb64-210e_spine-256x256_fold_"
WORK_DIR_PREFIX="work_dirs/td-hm_ViTPose-small_8xb64-210e_spine-256x256_fold_"
SHOW_DIR="viz/"
RESULT_FILES=()
TEMP_FILE="td-hm_ViTPose-small_8xb64-210e_spine-256x256.txt"
...
# Run folds sequentially, using one GPU at a time
for i in {1..5}
do
    run_fold $i 0  # Use GPU 2 for all folds
done
