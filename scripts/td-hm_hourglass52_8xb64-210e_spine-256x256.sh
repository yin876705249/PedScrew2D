...
CONFIG_PREFIX="configs/spine_2d_keypoint/topdown_heatmap/spine/td-hm_hourglass52_8xb64-210e_spine-256x256_fold_"
WORK_DIR_PREFIX="work_dirs/td-hm_hourglass52_8xb64-210e_spine-256x256_fold_"
SHOW_DIR="viz/"
RESULT_FILES=()
TEMP_FILE="td-hm_hourglass52_8xb64-210e_spine-256x256.txt"
...
for i in {1..5}
do
    run_fold $i 1  # Use GPU 2 for all folds
done
