...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        # ann_file='annotations/fold_1/spine_2d_train.json',  # Change to your train annotation file
        data_prefix=dict(img='images/'),  # Change to your train image folder
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        # ann_file='annotations/fold_1/spine_2d_val.json',  # Change to your val annotation file
        # bbox_file=None,  # Provide if needed
        data_prefix=dict(img='images/'),  # Change to your val image folder
        test_mode=True,
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        # ann_file='annotations/fold_1/spine_2d_test.json',  # Change to your val annotation file
        # bbox_file=None,  # Provide if needed
        data_prefix=dict(img='images/'),  # Change to your val image folder
        test_mode=True,
        pipeline=val_pipeline,
